...
Assert-Contains 'templates/frontend-booking.php' '6 m lang, 2,05 m breit und 2,522 m hoch' 'frontend communicates the van dimensions'
Assert-Contains 'templates/frontend-booking.php' 'Adresse oder Google-Maps-Link' 'frontend captures the exact van parking location'
...
Assert-Contains 'src/Admin/Menu.php' 'https://www.google.com/maps/search/' 'tour stops open their address in Google Maps'
