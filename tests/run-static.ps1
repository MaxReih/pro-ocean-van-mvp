...
Assert-Contains 'src/Service/PublicRecommendationService.php' 'REGIONAL_CLUSTER_BONUS' 'nearby same-state tour stops receive explicit ranking priority'
Assert-Contains 'src/Service/PublicRecommendationService.php' "PLANNED_TOUR_WINDOW" 'planned regional tour windows avoid the limited-day penalty'
Assert-Contains 'src/Routing/DemoGeocodingProvider.php' "'70180' => [48.7643, 9.1681, 'Stuttgart']" 'demo geocoding resolves the tested Stuttgart postcode exactly'
