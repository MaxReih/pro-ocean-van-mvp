...
Assert-Contains 'templates/frontend-booking.php' 'name="school_schedule_notes"' 'school bookings capture lessons and breaks'
...
Assert-Contains 'src/Admin/Menu.php' 'https://www.google.com/maps/dir/' 'complete weekly tours open with every stop in Google Maps'
Assert-Contains 'src/Admin/Menu.php' 'Gesamte Tour in Google Maps' 'tour planning offers one consolidated Google Maps action'
