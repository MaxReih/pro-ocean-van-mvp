...
Assert-Contains 'templates/frontend-booking.php' 'name="children_count"' 'frontend captures reached children'
Assert-Contains 'templates/frontend-booking.php' 'name="adult_count"' 'frontend captures reached adults'
