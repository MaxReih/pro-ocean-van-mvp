...
Assert-NotContains 'assets/vendor/pov-calendar/pov-calendar.js' '<small>${POVCalendar.escape(row.public_label)}</small>' 'calendar tiles contain no redundant state text'
