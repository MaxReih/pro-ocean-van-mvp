...
Assert-Contains 'templates/frontend-booking.php' 'id="pov-range-panel" data-role="range-panel"' 'frontend keeps the date-range alternative visible'
...
Assert-Contains 'templates/frontend-booking.php' '<i class="is-available"></i>Verfügbar' 'frontend legend uses the requested available label'
...
Assert-Contains 'templates/frontend-booking.php' 'data-action="select-calendar-week"' 'calendar offers one-click week selection'
