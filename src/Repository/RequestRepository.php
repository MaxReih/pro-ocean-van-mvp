...
final class RequestRepository
{
    public function create(array $payload): int
    {
        ...
        $inserted = $wpdb->insert($table, [
            ...
            'electricity_outdoor_location' => sanitize_text_field((string) ($payload['electricity_outdoor_location'] ?? '')),
    ...
    public function updateDetails(int $id, array $data): bool
    {
        ...
        $updated = $wpdb->update($wpdb->prefix . 'pov_requests', [
            ...
            'electricity_outdoor_available' => '',
            'electricity_outdoor_location' => sanitize_text_field((string) ($data['electricity_outdoor_location'] ?? '')),
